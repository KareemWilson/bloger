...
RSpec.describe 'Post Index', type: :system do
  describe 'Posts Index' do
    before(:each) do
      @user1 = User.create(name: 'Kareem', photo: 'https://www.pngfind.com/pngs/m/470-4703547_icon-user-icon-hd-png-download.png')
      @post1 = Post.create(title: 'Post number #1', text: 'This is post 1', user: @user1)
      @post2 = Post.create(title: 'Post number #2', text: 'This is post 2', user: @user1)
      @post3 = Post.create(title: 'Post number #3', text: 'This is post 3', user: @user1)
      @post4 = Post.create(title: 'Post number #4', text: 'This is post 4', user: @user1)
      @comment1 = Comment.create(text: 'This is a comment 1', user: @user1, post: @post1)
      @comment2 = Comment.create(text: 'This is a comment 2', user: @user1, post: @post1)
      @like1 = Like.create(user: @user1, post: @post1)
      @like2 = Like.create(user: @user1, post: @post1)
