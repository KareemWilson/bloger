  ...
  describe 'Show page' do
    before(:each) do
      @user1 = User.create(name: 'Kareem',
                           photo: 'https://www.pngfind.com/pngs/m/470-4703547_icon-user-icon-hd-png-download.png',
                           bio: 'I am kareem')
      @post1 = Post.create(title: 'post title 1', text: 'here is the post body', user: @user1)
      @post2 = Post.create(title: 'post title 2', text: 'here is the post body', user: @user1)
      @post3 = Post.create(title: 'post title 3', text: 'here is the post body', user: @user1)
      @post4 = Post.create(title: 'post title 4', text: 'here is the post body', user: @user1)
